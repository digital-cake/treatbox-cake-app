(() => {
  ...
  // extensions/line-item-address-display/src/Checkout.jsx
...
${errorInfo.componentStack}`);
  ...
  function Extension() {
    const [assignedAddress, setAssignedAddress] = (0, import_react12.useState)(null);
